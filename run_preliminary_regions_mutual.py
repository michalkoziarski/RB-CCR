...
from algorithms.v8 import CCRv8
...
def evaluate_trial(trial):
    for minority_training_size in [-1]:
        for dataset_name in datasets.names():
            RANDOM_STATE = 42
            RESULTS_PATH = Path(__file__).parents[0] / f'results_preliminary_regions_mutual_{minority_training_size}'
            ...
            resampler = ResamplingCV(
                CCRv8, classifier, seed=RANDOM_STATE, energy=energies,
